...
- **Version:** 0.22.0 (`pyproject.toml`) · **Framework:** FastMCP (mcp SDK >=1.11.0,<1.16.0), httpx, pydantic, Pillow
...
## Registered tool groups — 115 tools across 19 modules (`aeko_mcp/tools/`)
