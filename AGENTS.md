...
- **Version:** 0.10.0 (`pyproject.toml`) · **Framework:** FastMCP (mcp SDK >=1.11.0,<1.16.0), httpx, pydantic, Pillow
...
## Registered tool groups — 31 tools across 10 modules (`aeko_mcp/tools/`)
